...
namespace RM.Unify.Sdk.Client
{
    public class RmUnifyClientApi
    {
        ...
        /// <param name="http">IHttpContextAccessor</param>
        public RmUnifyClientApi(RmUnifyCallbackApi callbackApi, IHttpContextAccessor http)
        {
            _ssoHelper = new SsoImpl.SsoHelper(callbackApi, http);
        }
        ...
        public static bool IsRmUnifyUser(IHttpContextAccessor http)
        {
            return SsoImpl.SsoHelper.IsRmUnifyUser(http);
        }
    }
}
